...
public class NewBardRockStructure extends Structure {

    // A custom codec that changes the size limit for our code_structure_sky_fan.json's config to not be capped at 7.
    // With this, we can have a structure with a size limit up to 30 if we want to have extremely long branches of pieces in the structure.
    public static final Codec<NewBardRockStructure> CODEC = RecordCodecBuilder.<NewBardRockStructure>mapCodec(instance ->
            instance.group(NewBardRockStructure.configCodecBuilder(instance),
            ...
            ).apply(instance, NewBardRockStructure::new)).codec();
    ...
    public NewBardRockStructure(Structure.Config config,
    ...
    public Optional<Structure.StructurePosition> getStructurePosition(Structure.Context context) {
        ...
        if (!NewBardRockStructure.extraSpawningChecks(context)) {
    ...
    public StructureType<?> getType() {
        return MoreWeaponry.BARD_ROCK; // Helps the game know how to turn this structure back to json to save to chunks
    }
}
