...
public class EssenceTranslatorBlock extends BlockWithEntity implements BlockEntityProvider {
    public EssenceTranslatorBlock(Settings settings) {
        super(settings);
    }
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, MoreClientWeaponry.ESSENCE_TRANSLATOR_BLOCK_ENTITY, EssenceTranslatorEntity::tick);
    }
}
