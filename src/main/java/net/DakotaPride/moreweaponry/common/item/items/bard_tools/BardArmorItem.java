...
public class BardArmorItem extends ArmorItem implements IAnimatable {
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        if (Screen.hasShiftDown()) {
            ...
            tooltip.add(Text.translatable("text.abilities.bard.activate_key").formatted(Formatting.GRAY));
            tooltip.add(Text.literal(" "));
            tooltip.add(Text.translatable("misc.moreweaponry.shift_up").formatted(Formatting.DARK_GRAY));
        }
    }

    public BardArmorItem(ArmorMaterial material, EquipmentSlot slot, Settings settings) {
