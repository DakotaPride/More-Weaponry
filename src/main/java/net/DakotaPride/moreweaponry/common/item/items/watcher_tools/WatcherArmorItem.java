...
public class WatcherArmorItem extends ArmorItem implements IAnimatable {
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        if (Screen.hasShiftDown()) {
            ...
            tooltip.add(Text.translatable("text.abilities.watcher.activate_key").formatted(Formatting.GRAY));
    ...
    private <P extends IAnimatable> PlayState predicate(AnimationEvent<P> event) {
        ...
        // full set of armor
            ...
            boolean isWearingAll = armorList.containsAll(Arrays.asList(MoreWeaponry.WATCHER_HELMET,
