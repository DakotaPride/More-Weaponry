package net.DakotaPride.moreweaponry.common.item.items.wanderer_tools;
...
public class WandererArmorItem extends ArmorItem implements IAnimatable {
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        if (Screen.hasShiftDown()) {
            ...
            tooltip.add(Text.translatable("text.abilities.wanderer.activate_key").formatted(Formatting.GRAY));
            tooltip.add(Text.literal(" "));
            tooltip.add(Text.translatable("misc.moreweaponry.shift_up").formatted(Formatting.DARK_GRAY));
        }
    }

    public WandererArmorItem(ArmorMaterial material, EquipmentSlot slot, Settings settings) {
    ...
    private <P extends IAnimatable> PlayState predicate(AnimationEvent<P> event) {
        ...
        // full set of armor
            ...
            boolean isWearingAll = armorList.containsAll(Arrays.asList(MoreWeaponry.WANDERER_HELMET,
