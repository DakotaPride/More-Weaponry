...
public class WandererBattleaxe extends BattleaxeItem {
    public WandererBattleaxe(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
