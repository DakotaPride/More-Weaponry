...
public class ModBlocks {
    ...
    public static final Block CORE_FORGE = registerBlock("core_forge",
            new Block(FabricBlockSettings.copy(Blocks.OBSIDIAN)), ModItemGroup.MORE_WEAPONRY);
    ...
    public static final Block INTOXICATED_GRASS_BLOCK = registerBlock("intoxicated_grass_block",
            new IntoxicatedGrassBlock(FabricBlockSettings.copy(Blocks.GRASS_BLOCK)), ModItemGroup.MORE_WEAPONRY);
    ...
    public static final Block INTOXICATED_TALL_GRASS = registerBlock("intoxicated_tall_grass",
            new IntoxicatedTallPlantBlock(FabricBlockSettings.copy(Blocks.TALL_GRASS)), ModItemGroup.MORE_WEAPONRY);
