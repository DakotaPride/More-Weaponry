...
public class DustedGravesStructure extends StructureFeature<StructurePoolFeatureConfig> {

    public DustedGravesStructure() {
        super(StructurePoolFeatureConfig.CODEC, DustedGravesStructure::createPiecesGenerator, PostPlacementProcessor.EMPTY);
    }
    ...
    public static Optional<StructurePiecesGenerator<StructurePoolFeatureConfig>> createPiecesGenerator(StructureGeneratorFactory.Context<StructurePoolFeatureConfig> context) {
        ...
        if (!DustedGravesStructure.isFeatureChunk(context)) {
