...
public enum ModToolMaterial implements ToolMaterial {
    ...
    GLIMMERING_AMETHYST(MiningLevels.IRON, 546, 6.5f,
            1.5f, 23,
            () -> Ingredient.ofItems(ModItems.GLIMMERING_AMETHYST)),
    REFINED_MOON_STONE(MiningLevels.DIAMOND, 1278,8.5f,
            2.5f, 17,
            () -> Ingredient.ofItems(ModItems.REFINED_MOON_STONE)),
    ...
    BLACKSTONE_METAL(MiningLevels.NETHERITE, 2176, 9.5f,
            4.5f, 16,
            () -> Ingredient.ofItems(ModItems.BLACKSTONE_INGOT)),
    GUARDIAN_SCALE(MiningLevels.NETHERITE, 2458, 10.0f,
            5.5f, 18,
            () -> Ingredient.ofItems(ModItems.GUARDIAN_SCALE)),
    ELDER_GUARDIAN_SCALE(MiningLevels.NETHERITE, 2986, 10.5f,
            7.0f, 17,
            () -> Ingredient.ofItems(ModItems.ELDER_GUARDIAN_SCALE)),
    ...
    COOLED_CIRTICT(MiningLevels.NETHERITE, 3182, 12.0f,
            18.0f, 18,
            () -> Ingredient.ofItems(ModItems.COOLED_CIRTICT_INGOT)),
    CIRTICT(MiningLevels.NETHERITE, 3003, 11.5f,
            16.0f, 15,
            () -> Ingredient.ofItems(ModItems.CIRTICT_INGOT)),
    HEATED_CIRTICT(MiningLevels.NETHERITE, 3182, 12.0f,
            18.0f, 18,
            () -> Ingredient.ofItems(ModItems.HEATED_CIRTICT_INGOT)),
