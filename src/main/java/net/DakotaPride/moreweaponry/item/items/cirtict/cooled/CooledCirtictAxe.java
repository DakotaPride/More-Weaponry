...
public class CooledCirtictAxe extends ModAxeItem {


    public CooledCirtictAxe(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
