...
public enum ModArmorMaterial implements ArmorMaterial
{
    ...
    REFINED_MOON_STONE("refined_moon_stone", 16,
            ...
            0.0f, 0.0f, () -> Ingredient.ofItems(ModItems.REFINED_MOON_STONE)),
    ...
    GUARDIAN_SCALE("guardian_scale", 40,
            ...
            3.5f, 0.3f, () -> Ingredient.ofItems(ModItems.GUARDIAN_SCALE)),
    ELDER_GUARDIAN_SCALE("elder_guardian_scale", 42,
            new int[]{5, 8, 9, 6}, 19, SoundEvents.ENTITY_ELDER_GUARDIAN_AMBIENT,
            4.0f, 0.4f, () -> Ingredient.ofItems(ModItems.ELDER_GUARDIAN_SCALE)),
    PHANTOM_SCALE("phantom_scale", 23,
            new int[]{5, 7, 6, 5}, 18, SoundEvents.ENTITY_PHANTOM_BITE,
            3.5f, 0.3f, () -> Ingredient.ofItems(ModItems.PHANTOM_SCALE)),
    ENDER("ender", 45,
            new int[]{8, 11, 11, 8}, 21, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER,
            4.5f, 0.5f, () -> Ingredient.ofItems(ModItems.WATCHER_CLOTH)),
