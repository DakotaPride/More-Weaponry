...
public class EssenceCirtictKnife extends ModKnifeItem {


    public EssenceCirtictKnife(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
