...
public class SuppressedBattleaxe extends ModBattleaxeItem {
    public SuppressedBattleaxe(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
