...
public class PlaguedBattleaxe extends ModBattleaxeItem {
    public PlaguedBattleaxe(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
