...
public class BardBattleaxe extends ModBattleaxeItem {
    public BardBattleaxe(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
