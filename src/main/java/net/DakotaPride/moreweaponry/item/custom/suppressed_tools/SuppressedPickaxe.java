...
public class SuppressedPickaxe extends PickaxeItem {
    public SuppressedPickaxe(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
