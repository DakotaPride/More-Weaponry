...
public class WretchedCoreItem extends Item {
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (world.getBlockState(blockPos).isOf(ModBlocks.ESSENCE_TRANSLATOR)) {
            boolean bl;
            ...
            if (bl) {
                ...
                ItemStack itemStack2 = new ItemStack(ModItems.WRETCHED_ESSENCE, 4);
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        tooltip.add( new TranslatableText("item.moreweaponry.wretched_core.tooltip").formatted(Formatting.DARK_RED));
    }
