...
import net.DakotaPride.moreweaponry.item.custom.cores.PlaguedCoreItem;
...
public class PoweredPlaguedItem extends PlaguedCoreItem {
    public PoweredPlaguedItem(Settings settings) {
        super(settings);
    }
