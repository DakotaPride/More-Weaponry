...
public class PlaguedCoreItem extends Item {
    public PlaguedCoreItem(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (world.getBlockState(blockPos).isOf(MoreWeaponryBlocks.CORE_FORGE)) {
            ...
            if (bl) {
                ...
                ItemStack itemStack2 = new ItemStack(MoreWeaponryItems.POWERED_PLAGUED_MOB_CORE, 1);
