...
public class WatcherBattleaxe extends ModBattleaxeItem {
    public WatcherBattleaxe(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
