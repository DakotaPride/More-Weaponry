...
public class ModEntityType<T extends Entity> extends EntityType<PersistentProjectileEntity>
    ...
    public static final Entity ELDER_SCALE_TRIDENT = EntityType.createInstanceFromId("elder_scale_trident", new EntityFactory(ElderScaleTridentEntity::new, SpawnGroup.MISC) {


        public Entity create(EntityType var1, World var2) {
            return null;
        }
    }.setDimensions(0.5f, 0.5f).maxTrackingRange(4).trackingTickInterval(20));
